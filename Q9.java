...
public class Q9 extends AppCompatActivity {
    ...
    public void checkanswer(View v) {
        EditText et7 = (EditText) findViewById(R.id.et9);
        if (et7.getText().toString().trim().toLowerCase().equals("columbia")) {
            Toast toast = Toast.makeText(Q9.this, "Correct answer +5", Toast.LENGTH_SHORT);
            toast.getView().setBackgroundColor(Color.GREEN);
            toast.show();
            ((FlagQuiz)getApplicationContext()).totalScore += 5;
        } else {
            Toast toast = Toast.makeText(Q9.this, "Incorrect answer O points", Toast.LENGTH_SHORT);
            toast.getView().setBackgroundColor(Color.RED);
            toast.show();
        }
        startActivity(new Intent(Q9.this, Q10.class));
        this.finish();
    }
}
